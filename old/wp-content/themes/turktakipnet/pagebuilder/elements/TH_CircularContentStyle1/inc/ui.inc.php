...
?>
    <div class="kl-slideshow circularcarousel__slideshow <?php echo $style; ?> <?php echo $bm_class ?> <?php echo $this->data['uid']; ?> <?php echo $this->opt('css_class',''); ?>">
        ...
        <div class="kl-slideshow-inner container kl-slideshow-safepadding">
            <div class="row">
                <div class="ca-container" data-count="<?php echo $countitm; ?>">
                    ...
                    <div class="ca-wrapper ca-st1" data-autoplay="<?php echo $this->opt('ww_slider_autoplay') == 1 ? 1:0 ; ?>" data-timout="<?php echo $this->opt('ww_slider_timeout', 9000) ?>">
                        ...
                        if ( $hasItems )
                        {
                            ...
                            foreach ( $singleItem as $slide )
                            {
                                ...
                                if ( isset ( $slide['ww_slide_title'] ) && ! empty ( $slide['ww_slide_title'] ) ) {
                                    echo '<h3 class="ca-title">' . $slide['ww_slide_title'] . '</h3>';
                                }
                                ...
                                if ( isset ( $slide['ww_slide_read_text_content'] ) && ! empty ( $slide['ww_slide_read_text_content'] ) &&
                                    ...
                                    echo '<a href="' . $slide['ww_slide_link']['url'] . '" target="'
