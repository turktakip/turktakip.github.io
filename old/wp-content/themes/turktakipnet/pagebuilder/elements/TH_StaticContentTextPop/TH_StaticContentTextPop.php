                        ...
                        <div class="static-content textpop-style">
                            ...
                            <?php
                                ...
                                if ( ! empty ( $options['sc_pop_line1'] ) ) {
                                    echo '<span class="textpop__line1">' . $options['sc_pop_line1'] . '</span>';
                                }
                                // Line 2
                                if ( ! empty ( $options['sc_pop_line2'] ) ) {
                                    echo '<span class="textpop__line2">' . $options['sc_pop_line2'] . '</span>';
                                }
                                // Line 3
                                if ( ! empty ( $options['sc_pop_line3'] ) ) {
                                    echo '<span class="textpop__line3">' . $options['sc_pop_line3'] . '</span>';
                                }
                                // Line 4
                                if ( ! empty ( $options['sc_pop_line4'] ) ) {
                                    echo '<span class="textpop__line4">' . $options['sc_pop_line4'] . '</span>';
                                }
                                ?>
                            </div>
                            ...
                            <?php
                            // BUTTON
                            $mButton = (isset($options['ww_slide_m_button']) &&!empty($options['ww_slide_m_button']));
                            $slideText = (isset($options['ww_slide_l_text']) &&!empty($options['ww_slide_l_text']));
                            if ( $mButton || $slideText ) {
            ...
            'help' => array(
                ...
                'options' => array(
                    ...
                    array (
                        ...
                        "description" => __( '<span class="dashicons dashicons-video-alt3 u-v-mid"></span> <a href="http://support.hogash.com/kallyas-videos/#gPkT28UhG0k" target="_blank">Click here to access video tutorial for this element.</a>', 'zn_framework' ),
                        "id"          => "video_link",
                        "std"         => "",
                        "type"        => "zn_title",
                    ...
                    array (
                        ...
                        "description" => __( '<span class="dashicons dashicons-format-aside u-v-mid"></span> <a href="http://support.hogash.com/documentation/static-content-text-pop/" target="_blank">Click here to access documentation for this element.</a>', 'zn_framework' ),
                        "id"          => "docs_link",
                        "std"         => "",
                        "type"        => "zn_title",
                        "class"       => "zn_full zn_nomargin"
