...
<div class="kl-slideshow static-content__slideshow static-simpletext nobg <?php echo $uid; ?> <?php echo $scr_main_class; ?> <?php echo $this->opt('css_class',''); ?>">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            if (!empty( $options['sc_button_text'] ) && !empty( $options['sc_button_link']['url'] ) ) {
                                ...
                                echo '<a href="'.$options['sc_button_link']['url'].'" target="'.
                                     $options['sc_button_link']['target'].'" class="btn '.$this->opt('sc_button_style','btn-fullcolor').'">'.
                                     $options['sc_button_text'].'</a><span class="sc__line"></span>';
                                echo '</div>';
                            }
                            ?>
                        </div>
            ...
            'help' => array(
                ...
                'options' => array(
                    ...
                    array (
                        ...
                        "description" => __( '<span class="dashicons dashicons-video-alt3 u-v-mid"></span> <a href="http://support.hogash.com/kallyas-videos/#MrhHNfeZYrk" target="_blank">Click here to access video tutorial for this element.</a>', 'zn_framework' ),
                        "id"          => "video_link",
                        "std"         => "",
                        "type"        => "zn_title",
                    ...
                    array (
                        ...
                        "description" => __( '<span class="dashicons dashicons-format-aside u-v-mid"></span> <a href="http://support.hogash.com/documentation/static-content-simple-text/" target="_blank">Click here to access documentation for this element.</a>', 'zn_framework' ),
                        "id"          => "docs_link",
                        "std"         => "",
                        "type"        => "zn_title",
                        "class"       => "zn_full zn_nomargin"
