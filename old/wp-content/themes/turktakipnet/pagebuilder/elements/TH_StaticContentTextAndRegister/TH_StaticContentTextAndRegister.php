...
class TH_StaticContentTextAndRegister extends ZnElements
{
    ...
    function element()
    {
        ...
        ?>
<div class="kl-slideshow static-content__slideshow nobg <?php echo $uid; ?> <?php echo $bm_class ?> <?php echo $scr_main_class; ?> <?php echo $this->opt('css_class',''); ?>">
                    ...
                    <div class="row">
                        <div class="<?php echo $section_1_class;?>">
                            ...
                            if ( !empty( $options['ww_slide_m_button'] ) && !empty ( $options['ww_slide_l_text'] ) && !empty($options['ww_slide_link']['url']) ) {
                                ...
                                echo '<a href="'.$options['ww_slide_link']['url'].'" target="'.$options['ww_slide_link']['target'].'" class="sc-infopop__btn">'.$options['ww_slide_l_text'].'</a>';
                        ...
                        <div class="col-sm-10 col-sm-offset-1 col-md-5 col-md-offset-0">
                            <div class="fancy_register_form">
                                <h4 style="text-align:center"><?php _e("Create <strong>your account</strong> now",'zn_framework');?></h4>
            ...
            'help' => array(
                ...
                'options' => array(
                    ...
                    array (
                        ...
                        "description" => __( '<span class="dashicons dashicons-video-alt3 u-v-mid"></span> <a href="http://support.hogash.com/kallyas-videos/#o6M0q-d3ooc" target="_blank">Click here to access video tutorial for this element.</a>', 'zn_framework' ),
                        "id"          => "video_link",
                        "std"         => "",
                        "type"        => "zn_title",
                    ...
                    array (
                        ...
                        "description" => __( '<span class="dashicons dashicons-format-aside u-v-mid"></span> <a href="http://support.hogash.com/documentation/static-content-text-and-register/" target="_blank">Click here to access documentation for this element.</a>', 'zn_framework' ),
                        "id"          => "docs_link",
                        "std"         => "",
                        "type"        => "zn_title",
                        "class"       => "zn_full zn_nomargin"
