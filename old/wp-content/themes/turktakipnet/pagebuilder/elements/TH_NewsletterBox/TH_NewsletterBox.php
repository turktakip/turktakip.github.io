...
class TH_NewsletterBox extends ZnElements
{
    ...
    function css(){
        ...
        if( $width != 130 ){
            ...
            $css .= ".$uid .elm-nlbox__input {width:calc(100% - ". $width."px);}";
        }
        // height of the form
    ...
    function element()
    {
        ...
        <div class="elm-nlbox nlbox--style-<?php echo $this->opt('nb_style', 'normal'); ?> nlbox--layout-<?php echo $this->opt('nb_layout', 'single'); ?> <?php echo $uid; ?> <?php echo $this->opt('css_class',''); ?>">
            ...
            ?>
                <form method="post" class="elm-nlbox__form clearfix" data-url="<?php echo trailingslashit(home_url()) ?>" name="newsletter_form">
                    <input type="text" name="zn_mc_email" class="elm-nlbox__input nl-email form-control" value="" placeholder="<?php echo $this->opt('nb_em_pl'); ?>" required="required" />
                    <button type="submit" name="submit" class="elm-nlbox__submit nl-submit">
                        <?php
            ...
            'general' => array(
                ...
                'options' => array(
                    ...
                    array (
                        ...
                        "std"         => "#cd2122",
                        "type"        => "colorpicker",
                        "dependency"  => array( 'element' => 'nb_style' , 'value'=> array('normal','transparent') ),
                        'live' => array(
                            'type'        => 'css',
