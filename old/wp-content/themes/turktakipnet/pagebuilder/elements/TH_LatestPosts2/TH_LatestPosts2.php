...
class TH_LatestPosts2 extends ZnElements
{
    ...
    function element()
    {
        ...
        ?>
            ...
            <div class="latest_posts style3 clearfix <?php echo $this->data['uid']; ?> <?php echo $this->opt('css_class',''); ?>">
                    ...
                    while ( have_posts() ) {
                        ...
                        if ( has_post_thumbnail( $post->ID ) ) {
                            ...
                            if ( ! empty ( $thumb ) ) {
                                ...
                                $image = '<a href="' . get_permalink() . '" class="hoverBorder pull-left"><img src="'
