...
class TH_StaticContentReservationForm extends ZnElements
{
    ...
    function element()
    {
        ...
        ?>
        <div class="kl-slideshow static-content__slideshow sc--reservation-form <?php echo $style; ?> <?php echo $uid; ?> <?php echo $bm_class ?> <?php echo $scr_main_class; ?> <?php echo $this->opt('css_class',''); ?>">
                        ...
                        <div class="static-content sc--resform-style">
                            ...
                            if ( isset($options['ww_slide_m_button']) || !empty($options['ww_slide_l_text']) ) {
                                ...
                                if ( isset ( $options['ww_slide_link']['url'] ) && ! empty ( $options['ww_slide_link']['url'] ) ) {
                                    echo '<a class="btn btn-lined btn-lg btn-third" href="' . $options['ww_slide_link']['url'] . '" target="' . $options['ww_slide_link']['target'] . '">' . $options['ww_slide_l_text'] . '</a>';
                                }
    ...
    jQuery(function($){
        ...
        var endpointUrl = "<?php echo $options['ww_endpoint_url']['url'];?>",
            ...
            dayUrlField = "<?php echo (isset($options['ww_day_field'])&&!empty($options['ww_day_field']) ?
                                esc_attr($options['ww_day_field']) : 'm');?>",
            ...
            'help' => array(
                ...
                'options' => array(
                    ...
                    array (
                        ...
                        "description" => __( '<span class="dashicons dashicons-video-alt3 u-v-mid"></span> <a href="http://support.hogash.com/kallyas-videos/#Hv9y1Qa_5Tw" target="_blank">Click here to access video tutorial for this element.</a>', 'zn_framework' ),
                        "id"          => "video_link",
                        "std"         => "",
                        "type"        => "zn_title",
                    ...
                    array (
                        ...
                        "description" => __( '<span class="dashicons dashicons-format-aside u-v-mid"></span> <a href="http://support.hogash.com/documentation/static-content-reservation-form/" target="_blank">Click here to access documentation for this element.</a>', 'zn_framework' ),
                        "id"          => "docs_link",
                        "std"         => "",
                        "type"        => "zn_title",
                        "class"       => "zn_full zn_nomargin"
