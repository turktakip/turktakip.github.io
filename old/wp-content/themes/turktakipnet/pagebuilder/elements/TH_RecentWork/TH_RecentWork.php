...
<div class="recentwork_carousel recentwork_carousel--<?php echo (int)$rwStyleMod; ?> <?php echo $this->data['uid']; ?> <?php echo $this->opt('css_class',''); ?> clearfix">
			...
			'help' => array(
	            ...
	            'options' => array(
	                ...
	                array (
	                    ...
	                    "description" => __( '<span class="dashicons dashicons-video-alt3 u-v-mid"></span> <a href="http://support.hogash.com/kallyas-videos/#hnKkfdiu1Ig" target="_blank">Click here to access video tutorial for this element.</a>', 'zn_framework' ),
	                    "id"          => "video_link",
	                    "std"         => "",
	                    "type"        => "zn_title",
