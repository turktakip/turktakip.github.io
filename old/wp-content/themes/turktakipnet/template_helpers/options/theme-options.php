...
include( dirname(__file__). '/theme-options-pages/general-options/favicon-options.php' );
...
include( dirname(__file__). '/theme-options-pages/general-options/hidden-panel-options.php' );
