...
function zn_accordion( $atts, $content = null )
{
    ...
    $return .= '<button data-toggle="collapse" data-target="#acc' . $uid . '" class="acc-tgg-button collapsed ' .
...
<div class="panel acc-group">
	<div class="acc-panel-title">
		<a ' . $dataParent . ' data-toggle="collapse" href="#' . $pid . '" class="acc-tgg-button collapsed">' . $title . '<span class="acc-icon"></span></a>
	</div>
...
function zn_shortcode_tooltip( $atts, $content = null )
{
    ...
    $tooltipt = '<span ' . $border . ' data-rel="tooltip" data-placement="' . $placement . '" title="' . $title .
                '" data-animation="true">' . $content . '</span>';
    return $tooltipt;
}
...
function zn_shortcode_buttons( $atts, $content = null )
{
    ...
    extract( shortcode_atts( array( "style" => '',
                                    ...
                                    "target" => '' ), $atts ) );
    $button =
        ' <a href="' . $url . '" class="btn ' . $size . ' ' . $style . ' ' . $block . '" target="' . $target . '">' .
        $content . '</a>';
    return $button;
}
